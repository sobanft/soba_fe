        ...
        <div className={commonstyles.full_width}>
              <div className={commonstyles.area_width}>
                <div className={styles.singin_container}>
                  <div>
                    <img src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_singin.png" />
                  </div>
                  ...
                  <div className={styles.singin_bottom_container}>
                    <div className={styles.singin_bottom_title} onClick={this.handleClick}>
                      <img src="https://image.soribada.com/image/sobanft/images/web/img_w_btn_member_signin.png" />
                    </div>
