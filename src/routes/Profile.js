        ...
        <div className={commonstyles.full_width}>
            <div className={commonstyles.area_width}>
              <div className={styles.profile_container}>
                <div>
                  <img src="https://image.soribada.com/image/sobanft/images/web/img_w_title_mp_myprofile.png" />
                </div>
                ...
                <div className={styles.email_container}>
                  <div className={styles.email_title}>
                    ...
                    <img src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_email.png" />
                  </div>
                ...
                <div className={styles.password_container}>
                  <div className={styles.password_title}>
                    <img className={styles.dot_img} src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_importance.png" />
                    <img src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_password.png" />
                    <span className={styles.password_find_text}>Enter the password.</span>
                  </div>
                  <div className={styles.input_container}>
                ...
                <div className={styles.password_container}>
                  <div className={styles.password_title}>
                    ...
                    <span className={styles.password_find_text}>Enter the new password.</span>
                  </div>
                  <div className={styles.input_container}>
                ...
                <div className={styles.nickname_container}>
                  <div className={styles.nickname_title}>
                    <img className={styles.dot_img} src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_importance.png" />
                    <img src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_nickname.png" />
                  </div>
                  <div className={styles.input_container}>
                ...
                <div className={styles.profile_bottom_container}>
                  <div className={styles.profile_bottom_title}>
                    <img  onClick={this.handleClick}  src="https://image.soribada.com/image/sobanft/images/web/img_w_btn_myprofile_save.png" />
                  </div>
                </div>
              </div>
            </div>
