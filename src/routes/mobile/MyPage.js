...
import styles from '../../css/mobile/MyPage.module.css';
            ...
            <div className={styles.item_container}>
              <div className={styles.title_container}>
                ...
                <Link to={`/mypage/profile/`} className={styles.edit_container}>
                  <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_btn_editprofile.png" />
                </Link>
              </div>
                ...
                <div className={styles.mycollection_container}>
                  <div className={styles.mycollection_title_container}>
                    ...
                    <div className={styles.mycollection_title}>
                      <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/web/img_w_title_mp_mycollection.png" />
                    </div>
                  ...
                  <Link to={`/mypage/mycollection/`} className={styles.mycollection_more}>
                    <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_btn_more.png" />
                  </Link>
                  <Link to={`/mypage/mywallet/`}  className={styles.mywallet_title}>
                    <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_title_mp_mywallet.png" />
                  </Link>
                </div>
