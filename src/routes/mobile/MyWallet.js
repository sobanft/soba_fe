...
import styles from '../../css/mobile/MyWallet.module.css';
      ...
      <div>
        ...
        <div className={commonstyles.full_width_colume}>
            <div className={styles.recovery_container}>
              <div className={styles.mywallet_title_image}>
              ...
              <div className={styles.recovery_bottom_container}>
                <div className={styles.recovery_bottom_title} onClick={this.handleClick}>
                  <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_btn_connectwallet.png" />
                </div>
              </div>
            </div>
        </div>
