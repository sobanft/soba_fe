        ...
        <div className={commonstyles.full_width}>
            <div className={commonstyles.area_width}>
              <div className={styles.singup_container}>
                <div>
                  <img src="https://image.soribada.com/image/sobanft/images/web/img_w_title_member_singup.png" />
                </div>
                ...
                <div className={styles.singup_bottom_container}>
                  <div className={styles.singup_bottom_title}>
                    <img onClick={this.handleClick} src="https://image.soribada.com/image/sobanft/images/web/img_w_btn_member_signup.png" />
                  </div>
                </div>
              </div>
            </div>
