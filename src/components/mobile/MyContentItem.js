...
import styles from '../../css/mobile/MyContentItem.module.css';
  ...
  render(){
    ...
    return (
      <div className={styles.item_contaner}>
        ...
        <Link to={`/sobakit/product/`+id} className={styles.view_detail}>
          <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/web/img_w_btn_viewdetail.png" />
        </Link>
      </div>
    );
  }
