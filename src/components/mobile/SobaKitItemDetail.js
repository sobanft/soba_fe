...
import styles from '../../css/mobile/SobaKitItemDetail.module.css';
  ...
  handleClick = async (e) => {  
    ...
    if (ethereum && ethereum.isMetaMask) {
      ...
      if(this.state.isLogin){
        ...
        alert("Mobile purchases are available in the browser of the Metamask app.");
    }
      ...
      <div className={commonstyles.full_width_colume}>
        ...
        <div className={styles.itemdetail_container}>
          ...
          <div className={styles.itemdetail_buy_box}>
            <img  onClick={this.handleClick} className={styles.itemdetail_buy} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_btn_collectnow.png" />
          </div>
          
          
          <div className={styles.itemdetail_description_container}>
            <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_dummy_detail02.png" />
          </div>
          <div className={styles.itemdetail_description_container}>
            <img className={commonstyles.image_width} src="https://image.soribada.com/image/sobanft/images/mobile/img_m_dummy_detail03.png" />
          </div>
        </div>
      </div>
    );
